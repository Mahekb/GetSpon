...
<?php
    ...
    if(isset($_POST['addedit']) && !empty($_POST['addedit']) && isset($_POST['addressedittick'])){ 
        $update=$_POST['addedit'];
        $stmt=$conn->prepare("UPDATE user_details SET Address1=? WHERE Username=?");
       $stmt->bind_param('ss',$update,$username);
       $stmt->execute();
       $_POST['addedit']="";
    }
    ...
    <ul>
        ...
        <div align="center" id="reg">
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data" >
                ...
                <br><br>
                Address:<br>
                <textarea type = "textarea"  name = "address" class="input-box" rows="3" cols = "30" disabled ><?php echo $address;?></textarea>
                <button type="submit" style="font-size:24px" name="aedit" class="btn"><i class="fa fa-edit" style="color:white"></i></button>
                <input type = "text" style="display:<?php echo "$addressedit"?>" name = "addedit" class="input-box">
                <button type="submit" style="display:<?php echo "$addressedit"?>" class="btn"><i class="fa fa-close" style="color:white"></i></button>
                <button type="submit" style="display:<?php echo "$addressedit"?>" name="addressedittick" class="btnt"><i class="fa fa-check" style="color:white"></i></button>
                <br><br>
                City:
